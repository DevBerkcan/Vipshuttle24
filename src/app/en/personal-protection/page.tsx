      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="glass-card p-8 lg:p-12 space-y-8">
          <div>
            ...
            <p className="text-silver/70 text-sm leading-relaxed">{p.intro}</p>
          </div>

          <section className="space-y-4">
            {sections.map((section) => (
              <div key={section.title} className="glass-card p-5">
                <h2 className="text-silver font-semibold mb-2">{section.title}</h2>
                <p className="text-silver/70 text-sm leading-relaxed">{section.text}</p>
                {section.bullets && (
            ...
            <div className="glass-card p-5">
              <h2 className="text-silver font-semibold mb-2">{p.s6Title}</h2>
              <p className="text-silver/70 text-sm leading-relaxed mb-4">{p.s6p1}</p>
              <address className="not-italic text-silver/70 text-sm leading-relaxed">
